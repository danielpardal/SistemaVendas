...
<html>
    ...
    <body>
        ...
        <div id="show-vendas" class="content scaffold-show" role="main">
            ...
            <f:display bean="vendas" />
            <g:form resource="${this.vendas}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.vendas}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
